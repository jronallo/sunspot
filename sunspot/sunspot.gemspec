...
Gem::Specification.new do |s|
  s.name = 'jronallo-sunspot'
  s.version = Sunspot::VERSION
  s.executables = ['sunspot-solr', 'sunspot-installer']
  s.email = 'mat@patch.com'
  s.homepage = 'http://github.com/jronallo/sunspot/tree/as_and_typed_indexed_name'
...
TEXT
  s.authors = ['Mat Brown', 'Peer Allan', 'Dmitriy Dzema', 'Benjamin Krause', 'Marcel de Graaf', 'Brandon Keepers', 'Peter Berkenbosch', 'Brian Atkinson', 'Tom Coleman', 'Matt Mitchell', 'Nathan Beyer', 'Kieran Topping', 'Nicolas Braem', 'Jeremy Ashkenas', 'Dylan Vaughn', 'Brian Durand', 'Nick Zadrozny', 'Jason Ronallo']
